...
public class Restaurant {
    ...
    public boolean isRestaurantOpen() {
        ...
        LocalTime time1 = openingTime;
        LocalTime time2 = closingTime;
        LocalTime time3 = getCurrentTime();
        int timeBool1 = time1.compareTo(time3);
        int timeBool2 = time2.compareTo(time3);
        if(timeBool1<=0 && timeBool2 >=0)
            return true;
        else return false;
